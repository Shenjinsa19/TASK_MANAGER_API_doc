...
SECRET_KEY = 'django-insecure-!-ls6kf=e&@ih@k0$12!$i7-8ajhxp1_!w2v#43a5=!nlj=^g%'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'task_project_db',  # The name of your MySQL database
...
EMAIL_HOST_PASSWORD = 'lieqhpllerjiqfre'
